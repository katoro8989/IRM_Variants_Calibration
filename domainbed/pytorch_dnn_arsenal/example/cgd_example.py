...
def train(args, model, criterion, device, train_loader, optimizer, scheduler, epoch):
    model.train()
...
def main():
    ...
    wandb_project_name = 'arsenal_example'
    wandb.init(
    ...
    for epoch in range(1, args.epochs + 1):
        train(args, model, criterion, device, train_loader, optimizer, scheduler, epoch)
